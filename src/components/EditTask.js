...
<div className="row paddingTop10px">
    ...
    <div className="col-md-3">
    <input type="text" name="project" readOnly="true" value={this.state.project!==''?this.state.project:taskDetails.projectName} onChange={this.changeProject}  className="addComponentWidth"/>
    </div>
    <div className="col-md-3">
    ...
    <div className="col-md-9 addComponentWidth displayInlineFlex">
      ...
      <span>
      <input type="range"  value={this.state.priority!==0 || this.state.priority!=="0" || this.state.priority!==''?this.state.priority:taskDetails.priority} className="addComponentSliderWidth" id="customRange1" min="0" max="30"  onChange={this.changePriority}/>
      </span>
    ...
    <div className="col-md-3">
    <input type="text" name="user" readOnly="true" value={this.state.user!==''?this.state.user:taskDetails.user} onChange={this.changeUser}  className="addComponentWidth"/>
    </div>
    <div className="col-md-3">
